![Publish Status](https://github.com/ether/ep_author_hover/workflows/Node.js%20Package/badge.svg) [![Backend Tests Status](https://github.com/ether/ep_author_hover/actions/workflows/test-and-release.yml/badge.svg)](https://github.com/ether/ep_author_hover/actions/workflows/test-and-release.yml)
...
search for `ep_author_hover` and click *Install*), or from the Etherpad
root directory:

```sh
pnpm run plugins install ep_author_hover
```
